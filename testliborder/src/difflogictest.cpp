...
public:
    ...
    void testGraphActivate()
    {
        ...
        std::vector<DLPropagator::EdgeId> edges; /*= {DLPropagator::InternalEdge(y,4,w), DLPropagator::InternalEdge(w,2,z),
                                                   DLPropagator::InternalEdge(z,-3,y), DLPropagator::InternalEdge(y,5,z),
                                                   DLPropagator::InternalEdge(z,-7,x), DLPropagator::InternalEdge(x,3,y),
                                                   DLPropagator::InternalEdge(x,6,w)};*/
